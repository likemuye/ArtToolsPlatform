...
const PROJECT_EXTENSION_EXTRAS: Array<{
  ...
  { id: 'ext-11', name: 'Layer Batch Publisher', dccId: AppId.Photoshop, stage: 'character_concept', version: 'v1.6', latestVersion: 'v1.6', lifecycle: 'installed_latest', desc: '按项目命名规范批量整理图层并导出角色、场景与 GUI 切图。' },
  { id: 'ext-12', name: 'LOD Batch Builder', dccId: AppId.Max3ds, stage: 'scene_model', version: 'v2.0', latestVersion: 'v2.2', lifecycle: 'update_available', desc: '批量生成模型 LOD，检查材质槽与枢轴，并输出引擎侧报告。' },
  { id: 'ext-13', name: 'Houdini Terrain Stamp', dccId: AppId.Houdini, stage: 'scene_model', version: 'v1.4', latestVersion: 'v1.4', lifecycle: 'not_downloaded', desc: '项目地形侵蚀、道路压印与积雪遮罩的程序化 HDA 工具。' },
  ...
  { id: 'ext-15', name: 'Blender Hair Card Lab', dccId: AppId.Blender, stage: 'character_model', version: 'v0.9', latestVersion: 'v1.0', lifecycle: 'update_available', desc: '从曲线快速生成发片、自动展开 UV 并检查发片朝向。' },
  { id: 'ext-16', name: 'PS Concept Grid', dccId: AppId.Photoshop, stage: 'scene_concept', version: 'v1.2', latestVersion: 'v1.2', lifecycle: 'not_downloaded', desc: '快速创建透视网格、构图框与项目标准画布尺寸。' },
  { id: 'ext-17', name: 'Max Collision Helper', dccId: AppId.Max3ds, stage: 'scene_model', version: 'v2.7', latestVersion: 'v2.7', lifecycle: 'not_downloaded', desc: '根据模型层级生成碰撞体并检查命名、比例与导出轴向。' },
  ...
  { id: 'ext-20', name: 'Blender GUI Mockup', dccId: AppId.Blender, stage: 'ued', version: 'v1.0', latestVersion: 'v1.0', lifecycle: 'not_downloaded', desc: '在 Blender 中快速搭建游戏界面三维动效与镜头预演。' },
  { id: 'ext-21', name: 'PS Nine-Slice Exporter', dccId: AppId.Photoshop, stage: 'ued', version: 'v2.3', latestVersion: 'v2.3', lifecycle: 'installed_latest', desc: '读取切片标注并批量导出九宫格资源与配置清单。' },
...
export const INITIAL_ASSET_FOLDER_ASSIGNMENTS_PROJECT_A = ART_ASSETS_PROJECT_A.reduce<Record<string, string>>((acc, asset) => {
  ...
  const byCategory: Record<AssetCategory, string> = {
    ...
    [AssetCategory.CharConcept]: 'folder-primary',
    [AssetCategory.SceneConcept]: 'folder-primary',
    [AssetCategory.CharModel]: 'folder-primary',
    [AssetCategory.SceneModel]: 'folder-primary',
    [AssetCategory.Animation]: 'folder-primary',
    [AssetCategory.Video]: 'folder-primary',
    [AssetCategory.GUI]: 'folder-primary'
  };
